...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname === `${base}/opdracht-3` ? 'page' : undefined}>
				<a href="{base}/opdracht-3">3</a>
			</li>
			<li aria-current={$page.url.pathname === `${base}/opdracht-4` ? 'page' : undefined}>
				<a href="{base}/opdracht-4">4</a>
			</li>
		</ul>
		<svg viewBox="0 0 2 3" aria-hidden="true">
